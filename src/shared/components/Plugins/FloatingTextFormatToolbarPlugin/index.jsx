...
import type { NodeKey, ElementNode } from "lexical";
...
function TextFormatFloatingToolbar({
  ...
  const [, setSelectedElementKey] = useState<?NodeKey>(null);
      ...
      let element =
        anchorNode.getKey() === "root"
          ...
          : $findMatchingParent(anchorNode, (e) => {
              const parent = e.getParent<ElementNode>();
        ...
        <>
          ...
          >
            <Icon
              ...
              color={
                isStrikethrough ? "--primary-color-1" : "--neutral-color-800"
              }
            />
          </button>
          <button
          ...
          >
            <Icon
              ...
              icon="superscript"
              color={
                isSuperscript ? "--primary-color-1" : "--neutral-color-800"
              }
            />
          </button>
          <button
